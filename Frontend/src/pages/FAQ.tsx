...
export const faqs = [
  {
    question: "What is Revizely.ai?",
    answer: "Revizely AI is an all-in-one study companion platform that helps students organise notes, create flashcards, practice with past papers, and track their academic progress. It's designed to make studying more efficient and effective.",
  },
  {
    question: "Where do the past papers come from?",
    answer: "All past papers are accessed via direct links to verified third-party educational repositories like Physics & Maths Tutor (PMT). Revizely AI acts as a search engine and organiser—we do not host, store, or modify any exam content ourselves. All papers open in a new tab on the original source website, ensuring full compliance with copyright and 'no framing' policies.",
  },
  {
    question: "Is Revizely.ai free?",
    answer: "Yes! Revizely AI offers a free plan with access to basic features including notes, flashcards, and past papers. We also offer a Premium plan with advanced features like AI-powered tutoring and advanced analytics.",
  },
  {
  ...
  },
  {
    ...
    answer: "Currently, Revizely AI requires an internet connection to sync your flashcards across devices. However, we're working on offline support for future updates.",
  },
  {
    question: "What subjects are supported?",
    answer: "Revizely AI supports all subjects! You can create notes, flashcards, and organise materials for any subject you're studying. Popular subjects include Biology, Chemistry, Physics, Mathematics, and more.",
  },
  {
  ...
  {
    question: "Does Revizely AI comply with copyright laws for Past Papers?",
    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      ...
      <header className="border-b border-border bg-background/80 backdrop-blur-xl sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <AnimatedLogoIcon />
            <h1 className="font-bold text-xl">Revizely.ai</h1>
          </div>
          <div className="flex items-center gap-3">
            <Button
              variant="ghost"
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl space-y-8">
        <div className="text-center space-y-4 animate-fade-in">
          ...
          <p className="text-muted-foreground text-lg">
            Find answers to common questions about Revizely AI
          </p>
        </div>
      ...
      <footer className="border-t border-border bg-background/80 backdrop-blur-xl mt-12">
        <div className="container mx-auto px-4 py-8 text-center">
          <p className="text-sm text-muted-foreground">© 2026 Revizely.ai. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
