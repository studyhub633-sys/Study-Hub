                ...
                <ScrollArea className="h-[400px] my-4 p-4 border rounded-md">
                    <div className="space-y-6 text-sm text-muted-foreground">
                        <section>
                            ...
                            <p>
                                By participating in the Scientia.ai Beta, you agree to help us improve the platform by providing feedback and reporting any issues you encounter. In exchange, you will receive lifetime access to all current premium features.
                            </p>
                        </section>
                        ...
                        <div className="p-4 bg-muted/50 rounded-lg border border-dashed border-border">
                            ...
                            <p className="text-xs">
                                By clicking "Accept and Unlock", you confirm that you have read and understood these terms and agree to participate in the Scientia.ai Beta Testing Program.
                            </p>
                        </div>
                    </div>
                </ScrollArea>
